...
const TasksApp: React.FC<TaskAppProps> = ({ userId }) => (
    ...
    <div className="relative z-10 min-h-screen flex items-center justify-center">
      <div className="bg-white/80 backdrop-blur-md rounded-2xl shadow-xl p-8 max-w-md w-full mx-4 text-center">
        <Routes>
          ...
          <Route path="/addTag/:taskId" element={<AddTagToTask userId={userId} />} />
          <Route path="/tags/new/:taskId" element={<NewTag userId={userId} />} />
          <Route path="/tags/edit/:id/:taskId" element={<NewTag userId={userId} />} />
